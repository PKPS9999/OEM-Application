...
namespace QualityAssuranceService.Controllers
{
    [ApiController]
    ...
    public class QualityAssuranceController : ControllerBase
    {
        ...
        public QualityAssuranceController(ILogger<QualityAssuranceController> logger)
        {
            _logger = logger;
        }
        ...
        {
            return Ok($"QualityAssuranceService is running");
        }
